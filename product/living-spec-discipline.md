...
- **Temporal language patterns flagged** `FR-living-spec-temporal-audit-patterns`: The audit scans authoritative specs (product, design, engineering, QA — not roadmap) for temporal language patterns including:
  - **Phasing/versioning**: "MVP", "phase [N]", "iteration [N]", "first version", "V[N]", "initial release"
  - **Future-tense**: "will be added", "to be implemented", "planned for", "will support", "will include", "will provide", "will allow", "will enable"
