#!/usr/bin/env bash
#
# implement-context.sh test runner.
#
# Discovers every test-*.sh file in this directory, sources it, and invokes
# each `test_*` function. Prints PASS / FAIL per test and a final summary.
# Exits non-zero if any test fails.
#
# Usage: ./engineering/apps/cli/tests/implement/run-all.sh
